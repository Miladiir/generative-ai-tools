  ...
  it("world", async () => {
    const response = await openAi.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: 'assistant',
          content: 'Beep boop! Greetings, dear user! I am your friendly neighborhood robot, here to assist you. How may I beep boop you today?'
        },
        {
          role: 'user',
          content: 'Oh nothing, I am just making fun of you by making you do stupid noises.'
        }
      ],
    });
